...
//  self.services = [NSMutableArray array];
    ...
    myCenter = [[CBCentralManager alloc] initWithDelegate:self queue:dispatch_queue_create("com.myBLEQueue", NULL) options:options]; // TODO: options
...
{
    NSMutableString *nsmstring = [NSMutableString stringWithString:@"CoreBluetooth BLE: "];
    ...
    switch (central.state) {
        ...
        case CBCentralManagerStatePoweredOff:
            [nsmstring appendString:@"Powered Off\n"];
            break;
        case CBCentralManagerStatePoweredOn:
            [nsmstring appendString:@"Powered On and Ready\n"];
            break;
        default:
